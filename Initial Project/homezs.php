            ...
            <ul class="nav nav-pills nav-fill mb-3 mt-2 ml-2" id="pills-tab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-message-tab" data-bs-toggle="pill" data-bs-target="#pills-message"
                        type="button" role="tab" aria-controls="pills-message" aria-selected="false">Messages</button>
                </li>
                <li class="nav-item" role="presentation">
            ...
            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                <?php
                    if($_SESSION['role'] == 'Patient'){//Patient dashboard
                        $user = $_SESSION['email'];
                        $fetch ="SELECT * FROM appointments WHERE AppointmentFrom = '$user' AND Statuss = 'Pending'";
                    ...
                    <?php
                        ...
                        $fetch ="SELECT * FROM appointments WHERE AppointmentTo = '$currentUser' AND Statuss = 'Pending'";
                        $rs = $conns->query($fetch);
                        $rnum = $rs->num_rows;
                        if($rnum > 0){
                            ?>
                                ...
                                foreach($fetchAllData as $eList){
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><?php echo $eList['Payment']; ?></td>
                                            <td>
                                                <button type="button" class="btn btn-primary mt-2" onclick=location.href="<?php echo 'accept.php?a='.$eList['AppointmentEntry'].''?>">Accept</button>
                                                <button type="button" class="btn btn-danger mt-2" onclick=location.href="<?php echo 'delete.php?val='.$eList['AppointmentEntry'].''?>">Cancel</button>
                                            </td>
                                        </tr>
                                    <?php
