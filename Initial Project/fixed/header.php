...
<head>
    ...
    <title>Hospital Appointments Reservation</title>
    ...
    <div class="wrapper container">
        <div class="header">
            <div class="bg-primary">
                <div class="cen">
                    <img src="images/download.jpg" alt="" width="150" height="120" class="d-inline-block align-text-top">
                    <h1 id="sTitle">
                        ONLINE HOSPITAL APPOINTMENTS RESERVATION SYSTEM
                    </h1>
                </div>
            </div>
            <div class="whiteBG">
